            ...
            <div className="flex gap-2">
               <div className="relative">
                  ...
                  <input 
                     ...
                     className="bg-white/50 border border-secondary-100 rounded-xl pl-10 pr-4 py-2 text-xs font-bold focus:ring-2 focus:ring-primary-500/20 transition-all outline-none"
                  />
               </div>
