            ...
            <div className="lg:col-span-3 space-y-6">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {alertsLoading ? (
                     ...
                     alerts.map(alert => (
                        <div key={alert.id} className={`glass-card rounded-[2rem] p-5 border flex items-start gap-4 hover:scale-[1.02] transition-transform ${alert.severity === 'HIGH' ? 'bg-rose-50/50 border-rose-100' : 'bg-white/40 border-secondary-400/50'}`}>
