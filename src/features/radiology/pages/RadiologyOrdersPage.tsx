         ...
         <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               {[
                  ...
                  <div key={order.id} className="glass-card rounded-[2.5rem] p-8 border border-secondary-400/50 bg-white/40 hover:bg-white/60 transition-all group">
                     <div className="flex justify-between items-start mb-6">
                       ...
                       ${order.priority === 'URGENT' || order.priority === 'STAT' ? 'bg-rose-50 text-rose-600 border border-rose-100' : 'bg-secondary-50 text-secondary-600 border border-secondary-400'}
                    `}>
                           {order.priority}
                        </span>
                     </div>
