    ...
    <div className="space-y-10 animate-fade-in pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-1 space-y-6">
           <div className="glass-card rounded-[2.5rem] p-10 border border-secondary-100/50 bg-secondary-900 text-white shadow-premium">
                 ...
                 <div className="grid gap-3">
                    {group.items.map((item, i) => (
                       <div 
                          ...
                          className="glass-card rounded-[2rem] p-6 border border-secondary-100/50 bg-white/40 hover:bg-white/60 transition-all group cursor-pointer flex items-center justify-between"
                       >
