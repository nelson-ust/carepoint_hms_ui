      ...
      <div className="space-y-6">
         <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
               <div className="relative">
                  ...
                  <input type="text" placeholder="Search..." className="bg-white/50 border border-secondary-100 rounded-xl pl-10 pr-4 py-2 text-xs outline-none" />
               </div>
         ...
         <div className="grid gap-4">
            {isLoading ? (
               ...
               requests.map((req) => (
                  <div key={req.id} className="glass-card rounded-[2.5rem] p-8 border border-secondary-100/50 bg-white/40 hover:bg-white/60 transition-all flex flex-col md:flex-row md:items-center justify-between gap-6 group">
