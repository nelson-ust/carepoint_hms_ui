      ...
      <div className="space-y-10 animate-fade-in pb-20">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
            ...
            <div className="lg:col-span-3">
               <div className="glass-card rounded-[3rem] overflow-hidden border border-secondary-400/50 shadow-premium bg-white/40 min-h-[600px]">
                     ...
                     {timeSlots.map(time => {
                        ...
                        return (
                           <div key={time} className="flex min-h-[80px] group">
                              <div className="w-32 py-6 px-8 border-r border-secondary-400/50 flex flex-col items-center justify-center shrink-0">
