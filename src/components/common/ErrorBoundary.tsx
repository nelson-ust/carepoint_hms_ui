...
/**
 * Standard Class-based Error Boundary for component-level wrapping.
 */
 ...
 * Uses useRouteError() to capture errors thrown during routing/rendering.
 */
...
/**
 * The premium Error UI shared by both boundary types.
 */
