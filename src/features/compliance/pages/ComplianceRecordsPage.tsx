    ...
    <div className="space-y-10 animate-fade-in pb-20">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex gap-3">
          <button onClick={load} className="btn-secondary p-4 rounded-2xl bg-white/80 border-secondary-100">
         ...
         <div className="lg:col-span-3 space-y-6">
            <div className="flex items-center justify-between">
               <div className="relative max-w-sm w-full group">
                  ...
                  <input 
                     ...
                     className="w-full pl-12 pr-6 py-3 rounded-2xl bg-white/60 border border-secondary-100 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/5 transition-all text-sm font-medium outline-none"
                  />
               </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               {isLoading ? (
                  ...
                  records.map((record) => (
                     <div key={record.id} className="glass-card rounded-[2.5rem] p-8 border border-secondary-100/50 bg-white/40 hover:shadow-xl transition-all group">
