                           ...
                           <tr key={req.id} className="hover:bg-primary-50/20 transition-all group">
                              ...
                              <td className="px-8 py-6 text-right">
                                 <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-all">
                                    <button className="p-2.5 rounded-xl bg-white border border-secondary-100 text-secondary-400 hover:text-primary-600 transition-all shadow-sm">
                                       <CheckCircle2 className="h-4 w-4" />
                                    </button>
                                    <button className="p-2.5 rounded-xl bg-white border border-secondary-100 text-secondary-400 hover:text-rose-600 transition-all shadow-sm">
