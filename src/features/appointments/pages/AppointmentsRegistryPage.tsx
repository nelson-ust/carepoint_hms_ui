...
export function AppointmentsRegistryPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'COMPLETED': return 'bg-secondary-50 text-secondary-600 border-secondary-100';
    ...
    <div className="space-y-10 animate-fade-in pb-20">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex gap-3">
          <button onClick={load} className="btn-secondary p-4 rounded-2xl bg-white/80 border-secondary-100 hover:rotate-180 transition-transform duration-500">
         ...
         <div className="lg:col-span-1 space-y-6">
            ...
            <div className="glass-card rounded-[2.5rem] p-8 border border-secondary-100/50 bg-white/40 shadow-premium">
               ...
               <div className="relative">
                  ...
                  <input type="text" placeholder="Search staff..." className="w-full bg-white/50 border border-secondary-100 rounded-xl pl-10 pr-4 py-3 text-xs outline-none" />
               </div>
            </div>
         </div>
                              ...
                              <tr key={apt.id} className="hover:bg-primary-50/20 transition-all group">
                                 ...
                                 <td className="px-8 py-6 text-right">
                                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-all">
                                       <button className="p-2.5 rounded-xl bg-white border border-secondary-100 text-secondary-400 hover:text-primary-600 transition-all">
                                          <CheckCircle2 className="h-4 w-4" />
                                       </button>
                                       <button className="p-2.5 rounded-xl bg-white border border-secondary-100 text-secondary-400 hover:text-rose-600 transition-all">
