  ...
  return (
    <div className="space-y-10 animate-fade-in pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
         {categories.map((cat) => (
            <div key={cat.id} className="glass-card rounded-[2.5rem] p-8 border border-secondary-100/50 bg-white/40 hover:bg-white/60 transition-all cursor-pointer group shadow-premium">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="grid gap-4">
               {[
                 ...
                 { title: 'High-Value Stock Audit', cat: 'Inventory', date: 'May 11, 2026', size: '4.2 MB' },
                  ...
                  <div key={i} className="glass-card rounded-[2rem] p-6 border border-secondary-100/50 bg-white/40 flex items-center justify-between group hover:bg-primary-50/20 transition-all">
         ...
         <div className="lg:col-span-1 space-y-6">
            <div className="glass-card rounded-[2.5rem] p-8 border border-secondary-100/50 bg-secondary-900 text-white shadow-premium">
