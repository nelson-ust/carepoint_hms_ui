    ...
    <div className="space-y-10 animate-fade-in pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-8">
           <div className="glass-card rounded-[3rem] p-12 border border-secondary-100/50 bg-white/40 shadow-premium relative overflow-hidden">
        ...
        <div className="lg:col-span-1 space-y-6">
           <div className="glass-card rounded-[2.5rem] p-8 border border-secondary-100/50 bg-white/40 shadow-premium">
              ...
              <div className="p-4 rounded-2xl bg-secondary-900/5 flex items-center gap-4 border border-secondary-100">
                 <div className="h-10 w-10 rounded-xl bg-white flex items-center justify-center border border-secondary-100 shadow-sm">
